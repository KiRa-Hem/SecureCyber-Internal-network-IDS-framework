# Enhanced IDS/IPS System - Simple Demo Script for Windows
# This script runs a simplified demo of the IDS/IPS system
...
Write-ColorOutput $BLUE "  Enhanced IDS/IPS System - Simple Demo Mode"
Write-ColorOutput $BLUE "=============================================="
...
Write-ColorOutput $GREEN "  Simple demo is running!"
Write-ColorOutput $GREEN "=============================================="
...
Write-ColorOutput $YELLOW "Press Ctrl+C in the terminal window to stop the server"

# Wait for user input to stop the demo
Read-Host "Press Enter to stop the demo"

# Stop processes
Write-ColorOutput $YELLOW "Stopping server..."
if ($backendProcess) {
